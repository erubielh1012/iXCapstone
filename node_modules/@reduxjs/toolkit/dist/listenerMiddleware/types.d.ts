import type { Middleware, MiddlewareAPI, Action as ReduxAction, Dispatch as ReduxDispatch, UnknownAction } from 'redux';
import type { ThunkDispatch } from 'redux-thunk';
import type { BaseActionCreator, PayloadAction } from '@reduxjs/toolkit/dist/createAction';
import type { TaskAbortError } from '../../../../../frontend/node_modules/@reduxjs/toolkit/dist/listenerMiddleware/exceptions';
/**
 * @internal
...
/** @public */
export interface ListenerMiddlewareInstance<StateType = unknown, DispatchType extends ThunkDispatch<StateType, unknown, ReduxAction> = ThunkDispatch<StateType, unknown, UnknownAction>, ExtraArgument = unknown> {
 ...
 */
export interface AddListenerOverloads<Return, StateType = unknown, DispatchType extends ReduxDispatch = ThunkDispatch<StateType, unknown, UnknownAction>, ExtraArgument = unknown, AdditionalOptions = unknown> {
    ...
    <ActionCreatorType extends TypedActionCreator<any>>(options: {
    ...
    <T extends string>(options: {
        ...
        matcher?: never;
        predicate?: never;
        effect: ListenerEffect<ReduxAction<T>, StateType, DispatchType, ExtraArgument>;
    } & AdditionalOptions): Return;
...
/** @public */
export type RemoveListenerOverloads<StateType = unknown, DispatchType extends ReduxDispatch = ThunkDispatch<StateType, unknown, UnknownAction>> = AddListenerOverloads<boolean, StateType, DispatchType, any, UnsubscribeListenerOptions>;
/** @public */
 ...
 * @public
 */
export type TypedAddListener<StateType, DispatchType extends ReduxDispatch = ThunkDispatch<StateType, unknown, UnknownAction>, ExtraArgument = unknown, Payload = ListenerEntry<StateType, DispatchType>, T extends string = 'listenerMiddleware/add'> = BaseActionCreator<Payload, T> & AddListenerOverloads<PayloadAction<Payload, T>, StateType, DispatchType, ExtraArgument> & {
    /**
     ...
     * @since 2.1.0
     */
    withTypes: <OverrideStateType extends StateType, OverrideDispatchType extends ReduxDispatch = ThunkDispatch<OverrideStateType, unknown, UnknownAction>>() => TypedAddListener<OverrideStateType, OverrideDispatchType>;
};
/**
 ...
 * @public
 */
export type TypedRemoveListener<StateType, DispatchType extends ReduxDispatch = ThunkDispatch<StateType, unknown, UnknownAction>, Payload = ListenerEntry<StateType, DispatchType>, T extends string = 'listenerMiddleware/remove'> = BaseActionCreator<Payload, T> & AddListenerOverloads<PayloadAction<Payload, T>, StateType, DispatchType, any, UnsubscribeListenerOptions> & {
    /**
     ...
     * @since 2.1.0
     */
    withTypes: <OverrideStateType extends StateType, OverrideDispatchType extends ReduxDispatch = ThunkDispatch<OverrideStateType, unknown, UnknownAction>>() => TypedRemoveListener<OverrideStateType, OverrideDispatchType>;
};
/**
 ...
 * @public
 */
export type TypedStartListening<StateType, DispatchType extends ReduxDispatch = ThunkDispatch<StateType, unknown, UnknownAction>, ExtraArgument = unknown> = AddListenerOverloads<UnsubscribeListener, StateType, DispatchType, ExtraArgument> & {
    /**
     ...
     * @since 2.1.0
     */
    withTypes: <OverrideStateType extends StateType, OverrideDispatchType extends ReduxDispatch = ThunkDispatch<OverrideStateType, unknown, UnknownAction>>() => TypedStartListening<OverrideStateType, OverrideDispatchType>;
};
/**
 ...
 * @public
 */
export type TypedStopListening<StateType, DispatchType extends ReduxDispatch = ThunkDispatch<StateType, unknown, UnknownAction>> = RemoveListenerOverloads<StateType, DispatchType> & {
    /**
     * Creates a "pre-typed" version of
     ...
     * @since 2.1.0
     */
    withTypes: <OverrideStateType extends StateType, OverrideDispatchType extends ReduxDispatch = ThunkDispatch<OverrideStateType, unknown, UnknownAction>>() => TypedStopListening<OverrideStateType, OverrideDispatchType>;
};
/**
 ...
 * @public
 */
export type TypedCreateListenerEntry<StateType, DispatchType extends ReduxDispatch = ThunkDispatch<StateType, unknown, UnknownAction>> = AddListenerOverloads<ListenerEntry<StateType, DispatchType>, StateType, DispatchType> & {
    /**
